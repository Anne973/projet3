...
<p><?=$this->nettoyer($nbResultat)?> résultats pour votre recherche </p></div><?php
}

foreach ($resultat as $elementResultat){
    ?><div style ="padding-left:20px; padding-right:20px;"><h4><?=$this->nettoyer($elementResultat['BIL_TITRE']);?></h4>
